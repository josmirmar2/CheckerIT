...
from .views import (
    ...
    TableroViewSet, TurnoViewSet, MovimientoViewSet,
    IAViewSet, ChatbotViewSet, ParticipacionPartidaViewSet
)
...
router.register(r'participaciones', ParticipacionPartidaViewSet, basename='participacion')
